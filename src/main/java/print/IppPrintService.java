...
import print.attribute.IppAttributeName;
import print.attribute.IppStatus;
...
public class IppPrintService implements PrintService {
	...
	public Object getDefaultAttributeValue(Class category) {
		...
		if (category.equals(IppAttributeName.JOB_PRIORIY.getCategory())) {
			...
			if (attr != null) {
				value = Integer.valueOf(((IntegerSyntax) attr).getValue());
			}
			...
			if (attr != null) {
				value = Integer.valueOf(((TextSyntax) attr).getValue());
			}
			...
			if (attr != null) {
				value = Integer.valueOf(((IntegerSyntax) attr).toString());
			}
